...
public class RunBottomFeeder extends Command {    
  
  private final BallHandlingSubsystem m_BallHandlingSubsystem;
private final double m_Speed;
  /** Creates a new RunBottomFeeder. */
  public RunBottomFeeder(BallHandlingSubsystem ballHandlingSubsystem, double Speed) {
  ...
  @Override
  public void execute() {
    m_BallHandlingSubsystem.moveBottomFeeder(m_Speed);
