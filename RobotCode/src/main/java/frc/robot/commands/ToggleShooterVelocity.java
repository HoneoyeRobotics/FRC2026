...
public class ToggleShooterVelocity extends InstantCommand {
    private final BallHandlingSubsystem m_BallHandlingSubsystem;
private final double m_TargetVelocity;
  /** Creates a new ShootBalls. */
  public ToggleShooterVelocity(BallHandlingSubsystem ballHandlingSubsystem, double TargetVelocity) {
  ...
  public void initialize() {    
    m_BallHandlingSubsystem.toggleShooterVelocity(m_TargetVelocity);
  }
